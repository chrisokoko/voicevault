...
class AudioTranscriber:
    ...
    def transcribe_with_whisper_local(self, audio_file_path):
        """
    ...
    def _clean_overlapping_transcript(self, transcript):
        """
    ...
    def transcribe(self, audio_file_path, use_whisper_first=True):
        """
        ...
        if use_whisper_first:
            ...
            transcript = self.transcribe_with_whisper_local(audio_file_path)
            if transcript:
        ...
        transcript = self.transcribe_with_google(audio_file_path)
        if transcript:
